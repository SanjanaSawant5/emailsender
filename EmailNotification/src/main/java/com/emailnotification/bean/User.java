package com.emailnotification.bean;
...
public class User {
	...
	private String registrationv1doc;
	private String registrationexpiredate1;
	private String insurancev1doc;
	...
	private String registrationv2doc;
	private String registrationexpiredate2;
	private String insurancev2doc;
	private String insuranceexpiredate2;
	private String status2;
	
	public User(int id, String username, String password, int propertycode, String propertyname, int unit,
			String resident, String name, String vehiclenumber1, String registrationtenantname1, String licensenumber1,
			String vehiclemodel1, String registrationv1doc,String registrationexpiredate1, String insurancev1doc, String insuranceexpiredate1, String status1,
			String vehiclenumber2, String registrationtenantname2, String licensenumber2, String vehiclemodel2, String registrationv2doc, 
			String registrationexpiredate2, String insurancev2doc, String insuranceexpiredate2, String status2) {
		this.id = id;
		...
		this.registrationv1doc = registrationv1doc;
		this.registrationexpiredate1 = registrationexpiredate1;
		this.insurancev1doc = insurancev1doc;
		...
		this.registrationv2doc = registrationv2doc;
		this.registrationexpiredate2 = registrationexpiredate2;
		this.insurancev2doc = insurancev2doc;
	...
	public User(String username, String password, int propertycode, String propertyname, int unit, String resident,
	...
	public String getRegistrationv1doc() {
		return registrationv1doc;
	}

	public void setRegistrationv1doc(String registrationv1doc) {
		this.registrationv1doc = registrationv1doc;
	}

	public String getInsurancev1doc() {
		return insurancev1doc;
	}

	public void setInsurancev1doc(String insurancev1doc) {
		this.insurancev1doc = insurancev1doc;
	}

	public String getRegistrationv2doc() {
		return registrationv2doc;
	}

	public void setRegistrationv2doc(String registrationv2doc) {
		this.registrationv2doc = registrationv2doc;
	}

	public String getInsurancev2doc() {
		return insurancev2doc;
	}

	public void setInsurancev2doc(String insurancev2doc) {
		this.insurancev2doc = insurancev2doc;
	}
}